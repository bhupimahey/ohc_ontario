...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
 ...
 <?php echo view('includes/menu'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
							 <div class="card-header border-bottom">
                                    <h4 class="card-title"><i data-feather="plus-square"></i> View Vendors</h4>
                                    <a href='<?php echo base_url(); ?>/vendors/add' class="btn btn-primary me-1 waves-effect waves-float waves-light manage_button">Add New Vendor</a>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table" id="vendors_table">
   ...
   <script src="<?php echo base_url(); ?>/public/assets/js/vendors_datatable.js"></script>	
