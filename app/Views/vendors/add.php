	 ...
	 <div class="col-12">
	  <div class="card">
	   <div class="card-header border-bottom">
                                <h4 class="card-title"><i data-feather="plus-square"></i> Add Vendor Details</h4>
                            </div>
                            <div class="card-body py-2 my-25">
                                <!-- header section -->
                               
                                <form class="mt-2 pt-50" name="doctor-form" id="doctor-form" method="post" acton="<?php echo base_url();?>/vendors/add" enctype="multipart/form-data">
                                    <div class="row">		
                                      
                                    
                                     <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="firstName">Full Name*</label>
                                            <input type="text" class="form-control" id="vendorFlname" name="vendorFlname" required>
                                        </div>
                                    
                                        
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="firstName">Mobile*</label>
                                            <input type="text" class="form-control phone-number-mask" id="vendorMobile" name="vendorMobile" required>
                                        </div>										
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                       	...
                                       	<div class="col-12 col-sm-12 mb-1">
                                            ...
                                            <textarea cols="20" rows="5" class="form-control" id="vendorAddress" name="vendorAddress" required></textarea>
