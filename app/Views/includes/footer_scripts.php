<!-- BEGIN: Vendor JS-->
   ...
   <!-- <script src="<?php echo base_url();?>/public/app-assets/vendors/js/ui/jquery.sticky.js"></script>-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo base_url();?>/public/app-assets/js/scripts/pages/auth-login.js"></script>
