...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="<?php echo base_url();?>/public/app-assets/images/apple-icon-57x57.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url();?>/public/app-assets/images/apple-icon-57x57.png">
