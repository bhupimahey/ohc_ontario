<?php $header = array('title' => 'Staff Payroll Report'); ?>
                    ...
                    <div class="col-12">
                        <div class="card">
							 <div class="card-header border-bottom">
                                    <h4 class="card-title"><i data-feather="users"></i> Staff Payroll Report</h4>
                                    ...
                                    <form class="dt_adv_search">
                                        <div class="row g-1 mb-md-1">
                                            <div class="col-md-4">
                                               ...
                                               <?php  
                        						echo form_dropdown("filter_staff_id",$StaffDropdown,$filter_staff_id,'class="form-control select2" id="filter_staff_id" ');
                        						?> 
                                            </div>
                                            
											<div class="col-md-4">
                                                <label class="form-label">Date Range:</label>
                                                <input type="text" name="filter_daterange" id="filter_daterange" class="form-control flatpickr-range" value="<?php echo $start_date;?> to <?php echo $end_date;?>" data-column="1" placeholder="YYYY-MM-DD to YYYY-MM-DD" data-column-index="0">
                                            </div>
                                           
                                          <div class="col-md-1">
                                                <button  type="submit" id="search_staff_btn" class="btn btn-primary me-1 waves-effect waves-float waves-light manage_button" style="margin-top:23px;">Search</button>
                                            </div>
                                          <div class="col-md-1">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table dataTable">
                                    ...
                                    <tbody>
										<?php if($staff_result){ foreach($staff_result as $row){?>
										<tr>
...
<?php echo view('includes/footer_scripts'); ?>
   ...
   <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/public/app-assets/vendors/css/tables/datatable/dataTables.bootstrap5.min.css">
    ...
    <script src="<?php echo base_url(); ?>/public/assets/js/payroll_datatable.js"></script>	
...
window.location.href=	baseurl+"/report/export_staff_payroll/?filter_staff_id="+filter_staff_id+"&filter_daterange="+filter_daterange;
