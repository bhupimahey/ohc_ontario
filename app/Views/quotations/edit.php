<?php $header = array('title' => 'Modify Quotation');?> <?php echo view('includes/header',$header); ?> <body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
  <!-- BEGIN: Header--> <?php echo view('includes/inner_header'); ?>
  <!-- BEGIN: Main Menu--> <?php echo view('includes/menu'); ?> <div class="app-content content ">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header border-bottom">
                <h4 class="card-title">Modify Quotation</h4>
              </div>
              <div class="card-body py-2 my-25">
                <!-- header section --> <?php echo $message_output->run(); ?> <form class="mt-2 pt-50" name="enquiry-form" id="enquiry-form" method="post" acton="
									<?php echo base_url();?>/quotations/edit/<?php echo $quotation_id;?>" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-12 col-sm-6 mb-1">
                      <label class="form-label" for="firstName">Choose Customer</label>
                      <?php  echo form_dropdown("customer_id",$CustomerDropdown,$quotation_info['customer_id'],'class="form-control select2" id="customer_id" required');										   ?>
                    </div>
                    <div class="col-12 col-sm-6 mb-1">
                      <label class="form-label" for="motherName">Company Details</label>
                      <input type="text" class="form-control" id="company_details" name="company_details" value="<?php echo $quotation_info['company_detail'];?>">
                    </div>
                    <div class="col-12 col-sm-12 mb-1">
                      <label class="form-label" for="PinCode">Customer Location</label>
                      <textarea class="form-control" cols="30" rows="3" id="customer_location" name="customer_location"><?php echo $quotation_info['customer_location'];?></textarea>
                    </div>
                    <div class="col-6 col-sm-6 mb-1">
                      <label class="form-label" for="PinCode">Notes</label>
                      <textarea type="text" class="form-control" id="notes" name="notes"><?php echo $quotation_info['notes'];?></textarea>
                    </div>
                    <div class="col-12 col-sm-12 mb-1">
                      <table class="table table-striped imagestable" border="1">
                        ...
                        <tbody> <?php $counter=1500;
                        			$net_amount =0;
					            if($get_quotation_items){ 
								foreach($get_quotation_items as $jbrow){ ?> 
				        	<tr class="images_table_row" id="tr<?php echo $counter;?>">
                            <td> <?php echo form_dropdown("service_item[]",$PaymentHeads,$jbrow['item_id'].'||'.$jbrow['item_cost'],'class="form-control job_items_list" data-id="1" '); ?> </td>
                            <td>
                              <input type="text" class="form-control" name="service_desc[]" value="<?php echo $jbrow['item_desc'];?>">
                            </td>
                            <td>
                              <input type="text" name="service_cost[]" id="service_cost1" data-id="1" value="<?php echo $jbrow['item_cost'];?>" class="form-control countcost">
                            </td>
                            <td>
                              <div class="form-group">
                                <input type="button" class="btn btn-primary btn-sm remove_image"  data-id="<?php echo $counter;?>" value="Remove">
                              </div>
                            </td>
                          </tr> 
						  <?php        $counter++;   }    }   ?>
						  ...
						  <tr class="images_table_row">
                            <td> <?php echo form_dropdown("service_item[]",$PaymentHeads,'','class="form-control job_items_list" data-id="1" '); ?> </td>
                            <td>
                              <input type="text" class="form-control" name="service_desc[]">
                            </td>
                            <td>
                              <input type="text" name="service_cost[]" id="service_cost1" data-id="1" class="form-control countcost">
                            </td>
                            <td>
                              <div class="form-group">
                    ...
                    <div class="col-2 col-sm-2 mb-1">
                      ...
                      <input type="text" class="form-control" id="subtotal" name="subtotal" value="<?php echo $quotation_info['subtotal'];?>" readonly />
                    </div>
                    <div class="col-2 col-sm-2 mb-1">
                      <label class="form-label" for="PinCode">H.S.T(%)</label>
                      <input type="text" class="form-control" id="hst_payment" name="hst_payment" value="<?php echo $quotation_info['tax'];?>" />
                    </div>
                     <div class="col-2 col-sm-2 mb-1">
                      <label class="form-label" for="PinCode">Deposit(if any)</label>
                      <input type="text" class="form-control" id="deposit_payment" name="deposit_payment" value="<?php echo $quotation_info['deposit'];?>" />
                    </div>
                    
                    <div class="col-2 col-sm-2 mb-1">
                      <label class="form-label" for="PinCode">Total</label>
                      <input type="text" class="form-control" id="total_payment" name="total_payment" value="<?php echo $quotation_info['net_total'];?>" readonly />
                    </div>
                   
                    <div class="col-3 col-sm-3 mb-1">
                      <label class="form-label" for="PinCode">Balance</label>
                      <input type="text" class="form-control" id="balance" name="balance" value="<?php echo $quotation_info['net_total'];?>" readonly />
                    </div>
                    <div class="col-12">
  ...
  </div> <?php echo view('includes/footer_scripts'); ?>
...
$("#customer_id").on("change",function(){
 ...
 $("#deposit_payment").on("change",function(){
	 ...
	 $("#subtotal").val(subtotal);
	   ...
	   if( typeof advanced_payment_val === 'undefined' || advanced_payment_val==0)
	  advanced_payment_val =0;
	   ...
	   var total =   parseFloat(subtotal)-parseFloat(hst_val)-parseFloat(advanced_payment_val);
	   
	    $("#total_payment").val(total);   
	    
	   if(advanced_payment_val)
	     $("#balance").val(parseFloat(total)-parseFloat(advanced_payment_val));
	 else
	     $("#balance").val(total);
