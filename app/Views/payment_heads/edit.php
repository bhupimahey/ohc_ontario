<?php
$header = array('title' => 'Update Payment Head');
?>
	 ...
	 <div class="col-12">
	  <div class="card">
	   ...
	   <div class="card-header border-bottom">
                                <h4 class="card-title"><i data-feather="plus-square"></i> Update Payment Head Details</h4>
                            </div>
                            <div class="card-body py-2 my-25">
                                <!-- header section -->
                               
                                <form class="mt-2 pt-50" name="doctor-form" id="doctor-form" method="post" acton="<?php echo base_url();?>/heads/edit/<?php echo $head_id;?>" enctype="multipart/form-data">
                                    <div class="row">		
                                    
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="paymentHeadName">Payment Head Name</label>
                                            <input type="text" class="form-control" id="paymentHeadName" name="paymentHeadName" value="<?php echo $head_info['pay_head_name'];?>" required>
                                        </div>
                                        
                                        
                                          <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="paymentHeadCost">Cost</label>
                                            <input type="text" class="form-control" id="paymentHeadCost" name="paymentHeadCost" value="<?php echo $head_info['pay_head_cost'];?>" required>
                                        </div>
