<?php
$header = array('title' => 'Add Purchase Order');?>
	 ...
	 <div class="col-12">
	  <div class="card">
                        <div class="card-header border-bottom">
                                <h4 class="card-title">Add Purchase Order(Job Id: <?php echo sprintf( '%05d', $jobid );?>)</h4>
                                <a href="<?php echo base_url();?>/purchase_orders" class="btn btn-primary me-1 waves-effect waves-float waves-light">View Purchase Orders</a>
								
                         </div>
                         <div class="card-body py-2 my-25">
                                <!-- header section -->
                                <?php echo $message_output->run(); ?>
                                <form class="mt-2 pt-50" name="enquiry-form" id="enquiry-form" method="post" acton="<?php echo base_url();?>/purchase_orders/add" enctype="multipart/form-data">
                                    <div class="row">									
                                        <div class="col-12 col-sm-4 mb-1">
                                            <label class="form-label" for="firstName">Choose Vendor</label>
											<div id="custdiv">
                                            <?php  
                                             echo form_dropdown("vendor_id",$VendorsDropdown,'','class="form-control select2" id="vendor_id" required');
										   ?></div>
                                        </div>										 
                                     	  <div class="col-12 col-sm-4 mb-1">
                                        ...
                                        <table class="table table-striped imagestable" border="1">
                                          ...
                                          <tbody>
                                            <tr class="images_table_row">
                                              <td>
                                             <input type="text" name="item[]" id="item1" class="form-control">
										   </td>  
											  <td>
                                             <input type="text" name="itemdesc[]" id="itemdesc1"  class="form-control">
										   </td>  
										   <td>
                                             <input type="text" name="itemqty[]" id="itemqty1"  class="form-control qty" data-id="1">
										   </td>
											<td>
                                             <input type="text" name="itemprice[]" id="itemprice1"  class="form-control uprice" data-id="1">
										   </td> 
											<td>
                                             <input type="text" name="itemtotal[]" id="itemtotal1"  class="form-control countcost" data-id="1">
										   </td>	
                     	...
                     	<div class="col-2 col-sm-2 mb-1">
                      	...
                      	<div class="col-3 col-sm-3 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="discount_payment" name="discount_payment"/>
                      </div> 
                     	<div class="col-3 col-sm-3 mb-1">
                                            <label class="form-label" for="PinCode">Shipping</label>
                                             
                                            <input type="text" class="form-control" id="shipping_payment" name="shipping_payment"/>
                      </div> 
					<div class="col-3 col-sm-3 mb-1">
                       ...
                       <div class="col-12 col-sm-4 mb-1">
                        ...
                        <div class="col-12 col-sm-8 mb-1">
                                         <label class="form-label" for="PinCode">Terms</label>
                                          <textarea type="text" class="form-control" id="our_terms" name="our_terms" ></textarea>
                                  </div>
                                        <div class="col-12">
