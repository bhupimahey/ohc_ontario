                    ...
                    <div class="col-12">
                        <div class="card">
							   <div class="card-header border-bottom">
                                    <h4 class="card-title"><i data-feather="plus-square"></i> View Staff</h4>
                                    <a href='<?php echo base_url(); ?>/staff/add' class="btn btn-primary me-1 waves-effect waves-float waves-light manage_button">Add New Staff</a>
                                </div>
                                <div class="card-body mt-2">
                                    <form class="dt_adv_search">
                                        <div class="row g-1 mb-md-1">
                                            ...
                                            <div class="col-md-2">
                                                <button id="search_staff_btn" style="margin-top:20px;" type="button" class="btn btn-primary me-1 waves-effect waves-float waves-light manage_button">Search</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<?php echo view('includes/footer_scripts'); ?>
   ...
   <script src="<?php echo base_url(); ?>/public/assets/js/staff_datatable.js"></script>	
