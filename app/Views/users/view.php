                    ...
                    <div class="col-12">
                        <div class="card">
							 <div class="card-header border-bottom">
                                    <h4 class="card-title"><i data-feather="plus-square"></i> View Admins</h4>
                                    <a href='<?php echo base_url(); ?>/users/add' class="btn btn-primary me-1 waves-effect waves-float waves-light manage_button">Add New User</a>
                                </div>
                                    ...
                                    <form class="dt_adv_search">
                                        <div class="row g-1 mb-md-1">
											...
											<div class="col-md-3">
                                                ...
                                                <?php  echo form_dropdown("filter_user_role",$user_roles,'','class="form-control select2" id="filter_user_role" required'); ?>
                                            </div>
...
<?php echo view('includes/footer_scripts'); ?>
   ...
   <script src="<?php echo base_url(); ?>/public/assets/js/users_datatable.js"></script>	
