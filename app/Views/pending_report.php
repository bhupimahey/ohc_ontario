<?php $header = array('title' => 'Pending Payment Report'); ?>
...
<?php echo view('includes/menu'); ?>
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <!-- Basic Tables start -->
                <div class="row">
					 <div class="col-12"><?php echo $message_output->run(); ?></div>
                     <div class="col-12">
                        <div class="card">
					        <div class="card-body mt-2">
                                	<p><h4>Doctors Report</h4></p>
                               ...
                               <div class="table-responsive"><br>
                                        <table class="table" id="doctors_report_table">
    ...
    <script src="<?php echo base_url(); ?>/public/assets/js/doctors_report_datatable.js"></script>	
    ...
    <style>.dataTables_length label{float: right;margin-right: 21px;}
        .table-responsive{margin-top:-40px!important;}
